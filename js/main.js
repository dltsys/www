    ...
    new Vue({
      ...
      mounted: function () {
        ...
        $('.price-cards').each(function() {  
            ...
            $(this).find('.price-card-feature').each(function(){
                if($(this).height() > highestBox){  
                    highestBox = $(this).height();  
                }
            })

            console.log("FINE: highest: " + highestBox);
            $(this).find('.price-card-feature').height(highestBox);
        });

        $(".single-member-back-img").each(function () {
          $(this).css("background", "url(" + $(this).attr("data-background") + ")");
        })
      },
      destroyed: function () {
        console.log("FINE: destroyed");
      }
    });
  });
})